...
const TRUE_BILLS = [BILLS[1], BILLS[2], BILLS[3], BILLS[4], BILLS[5], BILLS[6]];
const POTENTIAL_BILLS = [BILLS[0], BILLS[7], BILLS[8]];
...
describe('AllBills', () => {
  ...
  beforeEach(() => {
    wrapper = mount(<AllBills bills={BILLS} fetchBills={getBills} />);
  });
  ...
  describe('Renders', () => {
    ...
    it('renders the true bills in the first tab of the Tab component', () => {
      const renderedBills = wrapper
        ...
        .at(0)
        .prop('bills');
      expect(renderedBills).toEqual(TRUE_BILLS);
    });

    it('renders the potential bills in the second tab of the Tab component', () => {
      const renderedBills = wrapper
        .find('Tabs')
        .find('Bills')
        .at(1)
        .prop('bills');
      expect(renderedBills).toEqual(POTENTIAL_BILLS);
    });
  });
});
